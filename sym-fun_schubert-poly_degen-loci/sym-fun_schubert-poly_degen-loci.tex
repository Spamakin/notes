...
\begin{sol}[\cite{book:YT} \S 9.1 Ex. 2]\label{ex:YT_9.1.2}
  ...
  \end{align*}
  where $\Delta(j_{1}, j_{2})(A)$ is the $2 \times 2$ minor of $A$ defined by picking columns $j_{1}, j_{2}$.
  From here, we must make an assumption based on which affine portion of $\mathbb{P}^{6}$ our matrix lives in.
  ...
  We give $A$ for each of these conditions respectively:
  \begin{align*}
    A =
    \begin{pmatrix}
      1 & 0 & -1 & -2 \\
