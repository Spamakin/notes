...
\begin{exercise}[\quest{\tcite{book:UAG} 1.3.11}]\label{ex:UAG_1.3.11}

\end{exercise}

\section{Affine Varieties}

\begin{exercise}[\quest{\tcite{book:UAG} 1.4.9}]\label{ex:UAG_1.4.9}
...
\begin{exercise}[\quest{\tcite{book:UAG} 2.2.1}]\label{ex:UAG_2.2.1}
\end{exercise}

\begin{exercise}[\tcite{book:UAG} 2.2.2]\label{ex:UAG_2.2.2}
...
\begin{exercise}[\tcite{book:UAG} 2.2.3]\label{ex:UAG_2.2.3}
...
\begin{exercise}[\tcite{book:UAG} 2.2.4]\label{ex:UAG_2.2.4}
...
\begin{exercise}[\quest{\tcite{book:UAG} 2.2.5}]\label{ex:UAG_2.2.5}
  Let $I$ as in \Cref{ex:UAG_2.2.4}.
...
\begin{exercise}[\tcite{book:UAG} 2.2.6]\label{ex:UAG_2.2.6}
  Let $I$ as in \Cref{ex:UAG_2.2.4}.
...
\begin{exercise}[\tcite{book:UAG} 2.2.7]\label{ex:UAG_2.2.7}
...
\begin{exercise}[\tcite{book:UAG} 2.2.8]\label{ex:UAG_2.2.8}
  Let $I$ be the following ideal:
  \[
    I = \ideal{x^{2} + \frac{3xy}{2} + \frac{y^{2}}{2} - \frac{3x}{2} - \frac{3y}{2}, xy^{2} - x, y^{3} - y}
  \]
  \begin{enumerate}[label= (\alph*)]
    \item Use the method described in~\cite[Prop. 2.2.7]{book:UAG} to show that $I$ is a radical ideal.
    \item Give a non-computational proof of the statement in \textbf{(a)} using the following observation:
          By the form of the generators of the ideals $I_{j}$ in~\Cref{ex:UAG_2.2.7}, we have that $V(I_{j})$ is a single point and $I(V(I_{j})) = I_{j}$.
          Thus, $I_{j} = \sqrt{I_{j}}$ by the Nullstellensatz.
          Then use~\Cref{ex:UAG_1.4.9}.
  \end{enumerate}
\end{exercise}
\begin{pf}
  \begin{enumerate}[label= (\alph*)]
