...
\begin{pf}
  ...
  See \quest{Sage code?} for a SageMath implementation of this.
\end{pf}
...
\begin{exercise}[\quest{\tcite{book:UAG} 2.2.4}]\label{ex:UAG_2.2.4}
\end{exercise}
...
\begin{pf}
  ...
  A quick \quest{SageMath} computation confirms this: $\dim \C[x, y] / I = 9$ and $\dim \C[x, y] / \sqrt{I} = 2$.
...
\begin{pf}
  ...
  \quest{TODO: SageMath compute table.}
  A quick Sagemath computation confirms this.
  \quest{TODO: Need to look at monomials in $\Q[x, y] / I$ for some reason.}
\end{pf}
