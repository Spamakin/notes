...
\begin{sol}[\quest{\cite{book:UAG} Ex. 1.2.6}]\label{ex:UAG_1.2.6}
...
\begin{sol}[\cite{book:UAG} Ex. 6.2.8]\label{ex:UAG_6.2.8}
  \begin{enumerate}
...
\begin{sol}[\cite{book:UAG} Ex. 6.2.10]\label{ex:UAG_6.2.10}
  \begin{enumerate}
    \item Let $R = k[x_{1}, \ldots, x_{5}]$.
          ...
          \quest{TODO: Further examples with computer.}
    \item Now let $R = k[x_{1}, \ldots, x_{n}]$.
          ...
          \quest{STUCK:} How do I show that $\ker(\varphi_{k - 1}) \subseteq \im(\varphi_{k})$?
  \end{enumerate}
\end{sol}
...
\begin{sol}[\cite{book:UAG} Ex. 6.3.3]\label{ex:UAG_6.3.3}
  \begin{enumerate}
...
\begin{sol}[\cite{book:UAG} Ex. 6.3.8]\label{ex:UAG_6.3.8}
  We first show a.\ $\implies$ c.
  \quest{STUCK.}
  Then c.\ $\implies$ b.\ $\implies$ a.\ is trivial and overall we have equivalence.
\end{sol}

\begin{sol}[\cite{book:UAG} Ex. 6.3.10]\label{ex:UAG_6.3.10}
...
\begin{sol}[\cite{book:UAG} Ex. 6.4.1]\label{ex:UAG_6.4.1}
  \[
    H_{M(d)}(t) = \dim_{k} M(d)_{t} = \dim_{k} M_{t + d} = H_{M}(t + d).
  \]
\end{sol}

\begin{sol}[\cite{book:UAG} Ex. 6.4.2]\label{ex:UAG_6.4.2}
  \begin{enumerate}
    \item
          \[
...
\begin{sol}[\cite{book:UAG} Ex. 6.4.3]\label{ex:UAG_6.4.3}
  \begin{enumerate}
...
\begin{sol}[\cite{book:UAG} Ex. 6.4.12]\label{ex:UAG_6.4.12}
  \begin{enumerate}
...
\begin{sol}[\cite{book:UAG} Ex. 6.4.13]\label{ex:UAG_6.4.13}
  \begin{enumerate}
...
\begin{sol}[\cite{book:UAG} Ex. 6.4.22]\label{ex:UAG_6.4.22}
  \begin{enumerate}
    ...
    \item We can use SageMath to get the following graded free resolution of $I$:
          ...
          \]
          By \Cref{ex:UAG_6.4.13}, this expression give the Hilbert polynomial for $t \geq \max\set{2 - 5, 3 - 5, 4 - 5} = -1$.
...
\begin{sol}[\cite{book:UAG} Ex. 7.1.2]\label{ex:UAG_7.1.2}
  \begin{enumerate}
    \item We have that
          \[
          ...
          See \Cref{fig:7-1-2a_plot} for some examples.
