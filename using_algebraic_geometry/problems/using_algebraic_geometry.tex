...
\begin{pf}[\cite{book:UAG} Ex. 1.1.1]\label{ex:UAG_1.1.1}
...
\begin{pf}[\cite{book:UAG} Ex. 1.1.2]\label{ex:UAG_1.1.2}
...
\begin{pf}[\cite{book:UAG} Ex. 1.1.3]\label{ex:UAG_1.1.3}
...
\begin{pf}[\cite{book:UAG} Ex. 1.1.4]\label{ex:UAG_1.1.4}
...
\begin{pf}[\cite{book:UAG} Ex. 1.1.5]\label{ex:UAG_1.1.5}
...
\begin{pf}[\cite{book:UAG} Ex. 1.1.6]\label{ex:UAG_1.1.6}
...
\begin{pf}[\cite{book:UAG} Ex. 1.1.7]\label{ex:UAG_1.1.7}
  \begin{enumerate}[label= (\alph*)]
...
\begin{pf}[\cite{book:UAG} Ex. 1.1.8]\label{ex:UAG_1.1.8}
  \begin{enumerate}[label= (\alph*)]
...
\begin{pf}[\cite{book:UAG} Ex. 1.1.9]\label{ex:UAG_1.1.9}
  \begin{enumerate}[label= (\alph*)]
...
\begin{pf}[\cite{book:UAG} Ex. 1.1.10]\label{ex:UAG_1.1.10}
  \begin{enumerate}[label= (\alph*)]
...
\begin{pf}[\cite{book:UAG} Ex. 1.1.11]\label{ex:UAG_1.1.11}
  \begin{enumerate}[label= (\alph*)]
    \item \quest{meh}
    \item \quest{meh}
...
\begin{pf}[\cite{book:UAG} Ex. 1.1.12]\label{ex:UAG_1.1.12}
  \begin{enumerate}[label= (\alph*)]
    \item \quest{meh}
...
\begin{pf}[\quest{\cite{book:UAG} Ex. 1.3.11}]\label{ex:UAG_1.3.11}

\end{pf}

\section{Affine Varieties}

\begin{pf}[\quest{\cite{book:UAG} Ex. 1.4.9}]\label{ex:UAG_1.4.9}
...
\begin{pf}[\quest{\cite{book:UAG} Ex. 2.1.1}]\label{ex:UAG_2.1.1}

\end{pf}

\begin{pf}[\quest{\cite{book:UAG} Ex. 2.1.2}]\label{ex:UAG_2.1.2}

\end{pf}

\begin{pf}[\cite{book:UAG} Ex. 2.1.3]\label{ex:UAG_2.1.3}
...
\begin{pf}[\quest{\cite{book:UAG} Ex. 2.1.4}]\label{ex:UAG_2.1.4}
  Numerically find all roots of $2z^{6} + 2z^{5} - z^{4} - z^{3} - 2z^{2} - 2z - 2$.
\end{pf}

\clearpage

\begin{pf}[\cite{book:UAG} Ex. 2.1.5]\label{ex:UAG_2.1.5}
...
\begin{pf}[\quest{\cite{book:UAG} Ex. 2.1.6}]\label{ex:UAG_2.1.6}
\end{pf}

\begin{pf}[\quest{\cite{book:UAG} Ex. 2.1.7}]\label{ex:UAG_2.1.7}
\end{pf}

\begin{pf}[\cite{book:UAG} Ex. 2.1.8]\label{ex:UAG_2.1.8}
  \begin{enumerate}[label= (\alph*)]
...
\begin{pf}[\cite{book:UAG} Ex. 2.1.9]\label{ex:UAG_2.1.9}
  \begin{enumerate}[label= (\alph*)]
    \item Let $p(z) = z^{2} + 1$.
          We have that
          \[
...
\begin{pf}[\cite{book:UAG} Ex. 2.1.10]\label{ex:UAG_2.1.10}
...
\begin{pf}[\quest{\cite{book:UAG} Ex. 2.2.1}]\label{ex:UAG_2.2.1}
\end{pf}

\begin{pf}[\cite{book:UAG} Ex. 2.2.2]\label{ex:UAG_2.2.2}
...
\begin{pf}[\cite{book:UAG} Ex. 2.2.3]\label{ex:UAG_2.2.3}
...
\begin{pf}[\cite{book:UAG} Ex. 2.2.4]\label{ex:UAG_2.2.4}
...
\begin{pf}[\quest{\cite{book:UAG} Ex. 2.2.5}]\label{ex:UAG_2.2.5}
...
\begin{pf}[\cite{book:UAG} Ex. 2.2.6]\label{ex:UAG_2.2.6}
