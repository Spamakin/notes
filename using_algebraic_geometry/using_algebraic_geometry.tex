...
\begin{exercise}[\quest{\tcite{book:UAG} 1.2.1}]\label{ex:UAG_1.2.1}

\end{exercise}

\begin{exercise}[\quest{\tcite{book:UAG} 1.2.2}]\label{ex:UAG_1.2.2}

\end{exercise}

\begin{exercise}[\tcite{book:UAG} 1.2.3]\label{ex:UAG_1.2.3}
...
\begin{exercise}[\quest{\tcite{book:UAG} 1.2.4}]\label{ex:UAG_1.2.4}
  Numerically find all roots of $2z^{6} + 2z^{5} - z^{4} - z^{3} - 2z^{2} - 2z - 2$.
\end{exercise}

\clearpage

\begin{exercise}[\tcite{book:UAG} 1.2.5]\label{ex:UAG_1.2.5}
