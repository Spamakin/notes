...
\begin{ex}[Equivalent Descriptions of the Projective Plane]\
  \begin{figure}[h]
    ...
    \caption{Representation of the Projective Plane as both $\textbf{S}^2$ and $\textbf{D}^{2}$}
    \label{fig:proj_plane}
...
\begin{ex}[Disk as Quotient of Cylinder]\label{ex: disk_quotient_cylinder}\
  \begin{figure}[h]
    ...
    \caption{$\textbf{D}^2$ as a Quotient of $\textbf{S}^1 \times I$}
    \label{fig:disk_quotient_cylinder}
  \end{figure}
...
\begin{ex}[Sphere as Quotient of Disk]\
  \begin{figure}[h]
    ...
    \caption{$\textbf{S}^2$ as a Quotient of $\textbf{D}^2$}
    \label{fig:sphere_quotient_disk}
  \end{figure}
...
\begin{defn}[$Y \cup_{f} X$]
  ...
  \end{enumerate}
  If $Y$ is a one-point space then this quotient space is just $X / A$.
