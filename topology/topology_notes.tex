...
\begin{ex}[Equivalent Descriptions of the Projective Plane]\
  \begin{figure}[h]
    ...
    \caption{Representation of the Projective Plane as both $\textbf{S}^2$ and $\textbf{D}^{2}$ \cite{proj_plane_pic}}
...
\begin{ex}[Sphere as Quotient of Disk]\
  \begin{figure}[h]
    ...
    \caption{$\textbf{S}^2$ as a Quotient of $\textbf{D}^2$ \cite{book:Bredon}}
...
\begin{defn}[Mapping Cylinder]\
  ...
  \begin{figure}[h]
    ...
    \caption{The Mapping Cylinder \cite{book:hatcher_AT}}
...
\end{prop}
\begin{pf}
  Suppose that $X$ is contractible, and so homotopy equivalenct to a one point space $\set{x_{0}}$.
