...
\begin{exercise}[\cite{book:Bredon} 1.3.5, 1.3.6, 1.3.7]
  \quest{TODO}
\end{exercise}
...
\begin{ex}[Topologist's Sine Curve, A Space that is Connected but not Arcwise Connected]
  The following is due to \quest{citation needed}.
...
\begin{exercise}[\cite{book:Bredon} 1.4.4]
  \quest{TODO}
\end{exercise}
