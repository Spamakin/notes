...
\quest{I know that image of an ideal is an ideal so omitting for now.}
...
Since \textbf{Lemma 1} holds and \quest{the only portion of the proof of \textbf{\S 5, Theorem 2} that uses the ordering} is the application of \textbf{Lemma 1}, we are done.
